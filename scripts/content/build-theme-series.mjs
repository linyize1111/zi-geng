...
const SERIES = [
    ...
    terms: [
      {
        ...
        zhuyin: "ㄈㄟ",
        short: "鮮紅、偏亮的紅。",
        long: "與絳比：緋較亮、較「新」；絳較深、較「沉」。寫裙、寫頰、寫旗可用緋；寫舊帳、暮色更深可用絳。",
        usage: "對照：緋＜絳＜殷（由亮到暗）。",
        daily: "她穿一件緋色旗袍，燈一打就更亮。",
        lit: "緋是還沒被時間壓暗的紅。",
        tags: ["顏色", "對照"],
      },
      {
        ...
        zhuyin: "ㄐㄧㄤˋ",
        short: "深紅。",
        long: "比緋深一階，帶古典與重量。宮廷、舊袍、秋楓常用。勿與「降」混。",
        usage: "「絳紫」「絳帳」。",
        daily: "秋山一層絳，像被夕陽醃過。",
        lit: "絳把熱鬧收進布料的厚裡。",
        tags: ["顏色", "對照"],
      ...
      },
      {
        ...
        zhuyin: "ㄧㄢ",
        short: "黑紅、暗紅（血乾後）。",
        long: "最沉的紅。血、鏽、夕陽盡處。與緋對讀：一鮮一枯。",
        usage: "「殷紅」「殷鑑」（另義）。寫血色用殷更準。",
        daily: "床單上一小塊殷紅，洗不掉。",
        lit: "殷是故事已經發生過的紅。",
        tags: ["顏色", "對照"],
      },
    ...
    terms: [
      {
        ...
        zhuyin: "ㄑㄧㄥ",
        short: "藍綠之間的古典色；亦指年輕。",
        long: "青衣、青天、青春。語境決定偏藍或偏綠。現代「藍／綠」更精準時，青留給文言氣或雙關。",
        usage: "「青出於藍」另義；寫色時接物。",
        daily: "窗簾是舊青，燈一開就發灰。",
        lit: "青是還沒被命名死的顏色。",
        tags: ["顏色", "對照"],
    ...
    terms: [
      {
        ...
        zhuyin: "ㄕㄚ",
        short: "輕薄透光的絲織。",
        long: "透、輕、曖昧。夏夜、簾後、若隱若現。對照錦：一透一密。",
        usage: "「窗紗」「紗帷」。",
        daily: "窗紗一掀，巷燈漏進來。",
        lit: "紗把視線變成猜測。",
        tags: ["織品", "對照"],
      },
      {
        ...
        zhuyin: "ㄌㄨㄛˊ",
        short: "疏薄有孔的絲織；文語重。",
        long: "羅袖、羅帷。比紗更古、更「文」。勿與「羅列」語感混淆。",
        usage: "古典敘事優先。",
        daily: "羅袖掃過桌沿。",
        lit: "羅把時間往文言推半寸。",
        tags: ["織品", "對照"],
      ...
      },
      {
        ...
        zhuyin: "ㄑㄧˇ",
        short: "有花紋的絲織；華麗。",
        long: "綺羅、綺麗。比錦更「文采／美感」詞，可寫風景與文筆。",
        usage: "「綺麗」「綺夢」。",
        daily: "夢境綺得不真實。",
        lit: "綺是美到幾乎虛假。",
        tags: ["織品", "對照"],
  ...
  },
  {
    ...
    terms: [
      ...
      {
        term: "面如土色",
        zhuyin: "ㄇㄧㄢˋ ㄖㄨˊ ㄊㄨˇ ㄙㄜˋ",
        short: "嚇到臉色灰白。",
        long: "成語感強；場面大時可用，日常宜節制。",
        usage: "驚嚇高潮。",
        daily: "警報一響，他面如土色。",
        lit: "土色是血退到故事外面。",
        tags: ["恐懼", "面貌"],
...
function cardFromTerm(series, t) {
  return {
    ...
    tags: Array.from(
      new Set(["主題卡", "對照學習", series.family, `系列:${series.id}`, ...(t.tags ?? [])]),
    ),
